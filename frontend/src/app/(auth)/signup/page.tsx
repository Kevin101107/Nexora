    ...
    return (
      <div className="min-h-screen bg-[#f4f1ea] dark:bg-[#0f0f17] flex flex-col justify-between text-gray-900 dark:text-white transition-colors duration-200">
        ...
        <div className="flex-1 flex items-center justify-center px-4 py-12">
          <div className="w-full max-w-md bg-white dark:bg-[#16162a] border border-gray-200 dark:border-white/[0.08] rounded-3xl p-8 sm:p-10 text-center shadow-xl shadow-gray-200/50 dark:shadow-black/40">
            ...
            <p className="text-sm text-gray-600 dark:text-gray-300 leading-relaxed mb-6">
              ...
              Click the link to verify your account and start finding teammates.
            </p>
            <Link
              href="/login"
      ...
      <div className="flex-1 flex items-center justify-center px-4 py-10">
        <div className="w-full max-w-md bg-white dark:bg-[#16162a] border border-gray-200 dark:border-white/[0.08] rounded-3xl p-8 sm:p-10 shadow-xl shadow-gray-200/50 dark:shadow-black/40">
          <div className="text-center mb-8">
            <h1 className="text-2xl sm:text-3xl font-black tracking-tight">Create your account</h1>
            <p className="mt-2 text-sm text-gray-500 dark:text-gray-400">
              Join students finding teammates and building projects
            </p>
          </div>
